...
<h3 class="box-title">This is the archives of all prior agents that has been deactivated.<br>You are able to reinstate them by clicking on the reinstate icon next to their listing.</h3>
<br><br>
...
<container>
                                                        ...
                                                        <form action="" method="post">
                                                            ...
                                                            <input type="submit" id="updateagentBtn" name="updateagentBtn" value="Update Agent" style="float:right;">
